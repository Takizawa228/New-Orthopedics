...
namespace test
{
    public partial class NewEntry : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            //работает
            var query = "select name_of from productsUser_db where name_of=@parm1";
            ...
            else
            {
                ...
                SqlCommand cmd = new SqlCommand("insert into productsUser_db (name_of, type_of, date_admission, date_term, count_of, postavka, price) values(@name_of,@type_of,@date_admission,@date_term,@count_of,@postavka,@price)", data.GetConnection());
        ...
        private void textBox4_price_TextChanged(object sender, EventArgs e)
        {

        }

        private void textBox3_postav_TextChanged(object sender, EventArgs e)
        {
        ...
        private void textBox1_type_TextChanged(object sender, EventArgs e)
        {
